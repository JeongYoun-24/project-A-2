...
@WebServlet("/revimg.do")
public class RevImgController extends HttpServlet {
	...
	protected void doHandler (HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String fileName = req.getParameter("rev_img");
		System.out.println(fileName);
		int rev_code = Integer.parseInt(req.getParameter("rev_code"));
		
		
		OutputStream out = resp.getOutputStream();
		String downFile = ARTICLE_IMAGE_REPO+"\\"+rev_code+"\\"+fileName;
