...
<body>
    ...
    <div class="logins p-3 m-3">
        <div class="container  d-flex justify-content-center w-100">
            <form action="${ctxPath}/users/managerlogin.do" method="post" class="" >
	...
	var auto;
	 ...
	 $('#btnLogin').click(function(e){
		...
		$.ajax({  //페이지가 아닌 데이터만 보내기
			type: "post",
			async: true, //true=비동기
			url: "${ctxPath}/users/managerlogin.do",
			dataType : 'text', //서버로부터 받은 데이터 타입
			
			data:{ "id":id,"pwd":pwd}, //매개변수
			...
			console.log(jsonMessage)
				...
				if(jsonMessage == "로그인오류"){
					$('#id_message').text("아이디틀림");
					
					
				}else if(jsonMessage == "비밀번호"){
					$('#pw_message').text("비밀번호틀림");
