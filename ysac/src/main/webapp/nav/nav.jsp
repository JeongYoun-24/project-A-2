                       ...
                       <div class="row">
                             ...
                             <ul class="navbar-nav login ">
                              ...
                              <li class="nav-item mx-4 ">
                               <a id="" href="${ctxPath}/users/cart"  data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="currentColor" class="bi bi-cart2" viewBox="0 0 16 16">
