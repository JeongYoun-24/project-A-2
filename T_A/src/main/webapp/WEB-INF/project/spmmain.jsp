            ...
            <div>
                <nav class=" navbar navbar-expand-lg bg-body-tertiary">
                    ...
                    <div class="container-fluid">
                     ...
                     <div>
                      <a  href="${ctxPath}/users/manager.do" class="mx-4"><svg  xmlns="http://www.w3.org/2000/svg" width="30" height="22" fill="currentColor" class="bi bi-person" viewBox="0 0 16 14">
