...
import com.ex01.service.RevService;
...
public class RevController extends HttpServlet {
	private static String ARTICLE_IMAGE_REPO = "C:\\JAVAstady2023\\JAVA\\T_A\\src\\main\\webapp\\project_A_img\\product_img";
...
//			String product_code = req.getParameter("product_code");
			...
			req.getRequestDispatcher(nextPage).forward(req, resp);
		}else if(action.equals("/loginID.do"))	{// 상품 상세 페이지 
